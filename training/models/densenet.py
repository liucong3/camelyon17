...
def densenet121(pretrained=False, **kwargs):
    ...
    model = DenseNet(num_init_features=64, growth_rate=32, block_config=(6, 12, 24, 16),
                     **kwargs)
    if pretrained:
        pretrained_dict = model_zoo.load_url(model_urls['densenet121'], model_dir='model_zoo_pth')
...
def densenet169(pretrained=True, **kwargs):
    ...
    model = DenseNet(num_init_features=64, growth_rate=32, block_config=(6, 12, 32, 32),
                     **kwargs)
    if pretrained:
        pretrained_dict = model_zoo.load_url(model_urls['densenet169'], model_dir='model_zoo_pth')
        update_state_dict(model, pretrained_dict)
    return model
...
def densenet201(pretrained=True, **kwargs):
    ...
    model = DenseNet(num_init_features=64, growth_rate=32, block_config=(6, 12, 48, 32),
                     **kwargs)
    if pretrained:
        pretrained_dict = model_zoo.load_url(model_urls['densenet201'], model_dir='model_zoo_pth')
        update_state_dict(model, pretrained_dict)
    return model
...
def densenet161(pretrained=True, **kwargs):
    ...
    model = DenseNet(num_init_features=96, growth_rate=48, block_config=(6, 12, 36, 24),
                     **kwargs)
    if pretrained:
        pretrained_dict = model_zoo.load_url(model_urls['densenet161'], model_dir='model_zoo_pth')
        update_state_dict(model, pretrained_dict)
    return model
